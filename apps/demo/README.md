...
5. In **Project Settings** → **General** → **Root Directory**, set it to `apps/demo`
6. Vercel will automatically detect Next.js and configure the project
...
3. In **Project Settings** → **General** → **Root Directory**, set it to `apps/docs`
